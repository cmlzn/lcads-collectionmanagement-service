...
describe("CollectionDocumentManager", () => {
  let ManagerClass;
  let manager;
  let req;
  ...
  beforeEach(() => {
    ...
    ManagerClass = proxyquire(
      "../../../../src/manager-layer/main/CollectionDocument/CollectionDocumentManager",
      {
  ...
  describe("constructor", () => {
    it("should initialize properties correctly", () => {
      ...
      expect(instance).to.have.property("objectName", "collectionDocument");
      expect(instance).to.have.property("modelName", "CollectionDocument");

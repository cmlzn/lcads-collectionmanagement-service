...
describe("CurationHistoryManager", () => {
  let ManagerClass;
  let manager;
  let req;
  ...
  beforeEach(() => {
    ...
    ManagerClass = proxyquire(
      "../../../../src/manager-layer/main/CurationHistory/CurationHistoryManager",
      {
  ...
  describe("constructor", () => {
    it("should initialize properties correctly", () => {
      ...
      expect(instance).to.have.property("objectName", "curationHistory");
      expect(instance).to.have.property("modelName", "CurationHistory");
